    ...
    try:
        ...
        for customer in customers:
            ...
            for address in adresses:
                ...
                default_shipping = 1 if address['default_shipping'] == 'true' else 0
                # is_primary_address = 1 if address['']
                ...
                if not (existing_address and existing_address[0] and existing_address[0]['name']):
                    ...
                    new_address.custom_last_name = last_name
                    new_address.email_id = email_id
                    new_address.is_shipping_address = default_shipping
